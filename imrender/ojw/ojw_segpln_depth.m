function [D info] = ojw_segpln_depth(images, P, depths, R, options)
%OJW_SEGPLN  Generate piecewise-planar disparity proposals for stereo
%
%   [D info] = ojw_segpln(images, P, depths, R, options)
%
...
%       to the output image.
%   depths - 1xM list of depths to sample at.
...
corr = zeros(X(1), X(2), numel(depths));
